...
public class StreamingTestDosActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_streaming_test_dos);

        /* VideoView */
        videoView = (VideoView) findViewById(R.id.streamingViewDos);
        videoView.setOnErrorListener(this);
        videoView.setOnPreparedListener(this);
        videoView.setOnCompletionListener(this);
        videoView.setVideoURI(Uri.parse(Constants.VIDEO_URL_WOWZA));
        inicioCargando = System.currentTimeMillis();
        videoView.start();

        /* SeekBar Video */
        videoProgressBar = (SeekBar) findViewById(R.id.videoProgressBarDos);
        ...
        siguienteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(StreamingTestDosActivity.this,
                        QoEStreamingTestDosActivity.class);
                ...
                cargaInicialVideo.setCodigoParametro(Constants
                        .CARGA_INICIAL_VIDEO_DOS);
                ...
                tiempoBufferingParam.setCodigoParametro(Constants
                        .TIEMPO_BUFFERING_DOS);
                ...
                cantBufferingParam.setCodigoParametro(Constants
                        .CANT_BUFFERING_DOS);
        ...
        progressLayout = (RelativeLayout) findViewById(R.id.progressLayoutDos);
        progressLayout.setVisibility(View.GONE);
    }
